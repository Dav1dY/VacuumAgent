...
class SystemInfo:
    def __init__(self):
        ...
        try:
            ...
            self.logger.error("SystemInfo_config was not found.")
            return
        ...
        try:
            ...
            self.logger.info("Config2Send_SystemInfo.json load success.")
        except FileNotFoundError:
            self.logger.error("Config2Send_SystemInfo.json was not found.")
            return
        except json.JSONDecodeError:
            self.logger.error("An error occurred while decoding the JSON.")
            return
